...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val profileViewModelFactory = ProfileViewModelFactory(userRepository, personalizationRepository)
        ...
        setContent {
            ...
            CampusAssistantTheme(globalFontEnabled = profileState.globalFontEnabled) {
                AppRoot(
                    appState = appState,
